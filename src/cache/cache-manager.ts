 ...
 */
export function validateCache(cache: CacheData, repoPath: string, oldPath: string, newPath: string): boolean {
	// Check paths match
 ...
 */
export function createCache(migrationStart: CommitInfo, oldPath: string, newPath: string): CacheData {
	return {
